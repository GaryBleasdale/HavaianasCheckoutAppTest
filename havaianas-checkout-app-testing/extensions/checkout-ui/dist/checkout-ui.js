...
${errorInfo.componentStack}`);
  ...
  var privacyPolicyBlock = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PrivacyPolicyAcceptance, {}));
  var breadCrumbBlock = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BreadCrumb, {}));
  function PrivacyPolicyAcceptance() {
    ...
    const checkboxContent = merchantCheckboxContent != null ? merchantCheckboxContent : "Please check this checkbox to continue";
    const checkboxError = merchantCheckboxError != null ? merchantCheckboxError : "Custom Error";
    const canBlockProgress = useExtensionCapability("block_progress");
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && checked == false) {
        return {
          behavior: "block",
  ...
  function BreadCrumb() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { children: "Hi" });
  }
})();
